    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link" href="{{url("/teamlead")}}">
                    <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                    Dashboard
                </a>
                <a class="nav-link" href="{{route('teamlead-profile')}}">
                ...
                <div class="collapse" id="collapseTaskLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{route('teamlead-show-new-task')}}">{{ __('New Task') }}</a>
                        <a class="nav-link" href="{{route('teamlead-show-complete-task')}}">{{ __('Completed Task') }}</a>
                    </nav>
                </div>
