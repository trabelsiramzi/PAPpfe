                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header text-center">
                            <h4 class="text-primary">Add Teamlead</h4>
                        </div>
                        <div class="card-body">
                            {{ Form::open(['route'=>'new-teamlead','method'=>'post','class'=>'form-horizontal','enctype'=>'multipart/form-data']) }}
...
{{--                            </div>--}}
                            <div class="form-group row">
                                {{Form::label('teamlead_official_id','ID',['class'=>'col-sm-3'])}}
                                <div class="col-sm-9">
                                    {{Form::text('teamlead_official_id','TEM-20'.rand(100000,999999),['class'=>'form-control','readonly'])}}
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                {{Form::label('teamlead_salary','Salary Per Month',['class'=>'col-sm-3'])}}
                                <div class="col-sm-9">
                                    {{Form::number('teamlead_salary','',['class'=>'form-control','required'])}}
                                    <span class="text-danger">{{$errors->has('teamlead_salary')? $errors->first('teamlead_salary'):''}}</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                {{Form::label('teamlead_account_number','Account Number',['class'=>'col-sm-3'])}}
                                <div class="col-sm-9">
                                    {{Form::text('teamlead_account_number','',['class'=>'form-control','required'])}}
                                    <span class="text-danger">{{$errors->has('teamlead_account_number')? $errors->first('teamlead_account_number'):''}}</span>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {{Form::file('teamlead_image',['accept'=>'image/*','required'])}}
                                    <span class="text-danger">{{$errors->has('teamlead_image')? $errors->first('teamlead_image'):''}}</span>
                                </div>
                            </div>
